...
public class GiangVienView extends JFrame {
    private JTextField txtMaGV, txtHoTen, txtNgaySinh, txtDiaChi, txtSoDT, txtChuyenNganh, txtSoTiet;
    private JComboBox<String> cboGioiTinh, cboHocHam, cboHocVi;
    ...
    private JPanel createInputPanel() {
        ...
        panel.add(createLabel("Mã giảng viên:"), gbc);
        gbc.gridx = 1;
        txtMaGV = createTextField();
        ...
        panel.add(createLabel("Học hàm:"), gbc);
        gbc.gridx = 1;
        cboHocHam = createComboBox(new String[]{"Giáo sư", "Phó giáo sư", "Tiến sĩ", "Thạc sĩ", "Cử nhân"});
        panel.add(cboHocHam, gbc);

        gbc.gridx = 2;
        panel.add(createLabel("Học vị:"), gbc);
        gbc.gridx = 3;
        cboHocVi = createComboBox(new String[]{"Tiến sĩ", "Thạc sĩ", "Cử nhân"});
        panel.add(cboHocVi, gbc);

        // Hàng 5
        gbc.gridx = 0; gbc.gridy = 4;
        panel.add(createLabel("Chuyên ngành:"), gbc);
        gbc.gridx = 1;
        txtChuyenNganh = createTextField();
        panel.add(txtChuyenNganh, gbc);

        gbc.gridx = 2;
        panel.add(createLabel("Khoa:"), gbc);
        gbc.gridx = 3;
        cboKhoa = new JComboBox<>();
        cboKhoa.setBackground(Color.WHITE);
        cboKhoa.setForeground(Color.BLACK);
        cboKhoa.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        panel.add(cboKhoa, gbc);

        // Hàng 6
        gbc.gridx = 0; gbc.gridy = 5;
        panel.add(createLabel("Số tiết giảng:"), gbc);
        gbc.gridx = 1;
        txtSoTiet = createTextField("0");
    ...
    private JPanel createTablePanel() {
        ...
        String[] columns = {"Mã GV", "Họ tên", "Ngày sinh", "SĐT", "Học hàm", 
                           "Học vị", "Chuyên ngành", "Khoa", "Số tiết", "Lương"};
    ...
    public JComboBox<String> getCboHocHam() { return cboHocHam; }
    public JComboBox<String> getCboHocVi() { return cboHocVi; }
    public JTextField getTxtChuyenNganh() { return txtChuyenNganh; }
    public JComboBox<Khoa> getCboKhoa() { return cboKhoa; }
    public JTextField getTxtSoTiet() { return txtSoTiet; }
